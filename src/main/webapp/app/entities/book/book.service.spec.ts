...
describe('Service Tests', () => {
  describe('Book Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Book(123, 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Book', async () => {
        const returnedFromService = { name: 'BBBBBB', title: 'BBBBBB', price: 1, ...elemDefault };
      ...
      it('should partial update a Book', async () => {
        const patchObject = { title: 'BBBBBB', price: 1, ...new Book() };
