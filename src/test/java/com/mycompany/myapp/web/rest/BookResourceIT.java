...
class BookResourceIT {
    ...
    public static Book createEntity() {
        return new Book().name(DEFAULT_NAME).title(DEFAULT_TITLE).price(DEFAULT_PRICE);
    }
    ...
    public static Book createUpdatedEntity() {
        return new Book().name(UPDATED_NAME).title(UPDATED_TITLE).price(UPDATED_PRICE);
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).title(UPDATED_TITLE).price(UPDATED_PRICE);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).title(UPDATED_TITLE).price(UPDATED_PRICE);
