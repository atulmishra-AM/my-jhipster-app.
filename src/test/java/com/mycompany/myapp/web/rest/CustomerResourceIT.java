...
class CustomerResourceIT {
    ...
    private static final Double DEFAULT_ORDER_ID = 1D;
    private static final Double UPDATED_ORDER_ID = 2D;
    ...
    public static Customer createEntity() {
        return new Customer().name(DEFAULT_NAME).orderId(DEFAULT_ORDER_ID);
    }
    ...
    public static Customer createUpdatedEntity() {
        return new Customer().name(UPDATED_NAME).orderId(UPDATED_ORDER_ID);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).orderId(UPDATED_ORDER_ID);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).orderId(UPDATED_ORDER_ID);
